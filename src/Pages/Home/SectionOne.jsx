          ...
          <div className="relative w-fit h-fit">
            <form>
              <input
                ...
                className="lg:w-[29rem] md:w-[26rem] sm:w-[25rem] w-[16rem] lg:py-[20px] md:py-[17px] sm:py-[15px] py-[10px] focus:outline-0 lg:placeholder:text-base md:placeholder:text-base sm:placeholder:text-md placeholder:text-xs indent-2 relative rounded-sm bg-lightblue-100 transition-all"
              />
              <button
                type="submit"
                className="absolute right-0 self-center bg-darkblue-100 text-white lg:text-base md:text-base sm:text-sm text-[10px] rounded-sm lg:px-2 lg:py-2 md:py-[0.4rem] sm:py-[0.3rem] py-[0.4rem] text-bold md:px-[0.4rem] sm:px-[0.5rem] px-[0.4rem] sm:mr-2 mr-1 lg:top-[13px] md:top-[10px] sm:top-[13px] top-[9px] transition-all"
              >
                Get Download Link
              </button>
            </form>
